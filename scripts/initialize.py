"""Initialize a repository created from the Augent use-case template."""
...
def initialize(project: str, package: str, display: str, description: str) -> None:
    ...
    replacements = {
        "augent-usecase": project,
        "augent_usecase": package,
        "Augent Use Case": display,
        "Independent business use case powered by Augent Core": description,
    ...
    source_package = ROOT / "augent_usecase"
...
def main() -> None:
    ...
    description = args.description or f"{display} powered by Augent Core"
